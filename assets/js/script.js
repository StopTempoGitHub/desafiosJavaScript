...
const setCarrito = objeto => {
    ...
    carrito[producto.id] = {...producto}; //Con los "..." (spread) estamos haciendo una copia de la información en la const producto.
    pintarCarrito();
};
...
const pintarFooter = () => {
    ...
    btnVaciar.addEventListener('click', () => {
        carrito = {}; // Con esta linea indicamos que el carrito vuelva a 0
        pintarCarrito(); //Con esta linea visualizamos los cambios
        // SWEET ALERT
        swal({
            title: "¡Carrito Vacío!",
            text: "Has quitado todos los productos del carrito."
          });
    });
    ...
    btnComprar.addEventListener('click', () => {
        ...
        swal({
            ...
            text: "Has comprado todos los productos del carrito."
          });
    });
};
